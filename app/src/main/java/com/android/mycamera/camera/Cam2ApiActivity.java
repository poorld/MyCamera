...
public class Cam2ApiActivity extends BaseAct {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cam2_api);
    ...
    private void createCameraPreviewSession() {
        try {
            ...
            captureRequestBuilder.addTarget(surface); // 将预览 Surface 添加为目标

            // 创建一个包含预览 Surface 和拍照 ImageReader Surface 的 CaptureSession
            cameraDevice.createCaptureSession(Arrays.asList(surface, imageReader.getSurface()), new CameraCaptureSession.StateCallback() {
                ...
                public void onConfigureFailed(@NonNull CameraCaptureSession session) {
                    Toast.makeText(Cam2ApiActivity.this, "Configuration change", Toast.LENGTH_SHORT).show();
                }
            }, null);
        } catch (CameraAccessException e) {
        ...
        try {
            ...
            cameraCaptureSession.capture(captureBuilder.build(), new CameraCaptureSession.CaptureCallback() {
                ...
                public void onCaptureCompleted(@NonNull CameraCaptureSession session, @NonNull CaptureRequest request, @NonNull TotalCaptureResult result) {
                    ...
                    Toast.makeText(Cam2ApiActivity.this, "照片已保存 " + fileName, Toast.LENGTH_SHORT).show();
    ...
    private class ImageSaver implements Runnable {
        ...
        public void run() {
            ...
            try {
                File file = Utils.getOutputMediaFile(Cam2ApiActivity.this);
